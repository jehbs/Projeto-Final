...
if __name__ == "__main__":
    ...
    for circuito in circuitos:
        ...
        clf = DecisionTreeClassifier(random_state=20).fit(X_train, y_train)
...
#        fscore_train_results = fbeta_score(y_train, clf_train_predictions, beta=0.5)
#        fscore_test_results = fbeta_score(y_test, clf_test_predictions, beta=0.5)

        #print("acurácia teste: {} \t acurácia treino: {}\n fscore teste: {} \t fscore treino: {}".format(acc_test_results,acc_train_results,fscore_test_results,fscore_train_results))
        print("acurácia teste: {} \t acurácia treino: {}".format(acc_test_results,acc_train_results))
        print("Predição: {}".format(clf.predict(dadosPaa.iloc[1199, :].values.reshape(1, -1))))
        '''
